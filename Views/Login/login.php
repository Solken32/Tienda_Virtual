...
<html lang="es">
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="mb-3">
            <div class="utility">
              <p class="semibold-text mb-2"><a href="#" data-bs-toggle="flip">¿Olvidaste tu contraseña?</a></p>
            </div>
          </div>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="mb-3 mt-3">
            <p class="semibold-text mb-0"><a href="#" data-bs-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> Iniciar sesión</a></p>
          </div>
        </form>
      </div>
    </section>
    ...
    <script type="text/javascript" src="<?= media();?>/js/plugins/sweetalert2.js"></script>
