      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<?= base_url(); ?>/usuarios"><i class="icon bi bi-people-fill"></i> Usuarios</a></li>
                <li><a class="treeview-item" href="<?= base_url(); ?>/roles"><i class="icon bi bi bi-file-text-fill"></i> Roles</a></li>
            </ul>
        </li>
        <?php } ?>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="<?= base_url(); ?>/productos"><i class="icon bi bi bi-bar-chart-steps"></i> Productos</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/categorias"><i class="icon bi bi bi-box-seam-fill"></i> Categorías</a></li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
        ...
        <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
        <li>
            <a class="app-menu__item" href="<?=base_url();?>/reembolso">
                <i aria-hidden="true"></i>
                <span class="app-menu__label">Reembolso</span>
            </a>
        </li>
        <?php } ?>
