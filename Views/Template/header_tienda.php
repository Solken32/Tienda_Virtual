	...
	<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						<a href="#" class="flex-c-m trans-04 p-lr-25" data-bs-toggle="modal" data-bs-target="#modalAyuda" >
							Help & FAQs
						</a>
						<?php 
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						<a href="#" class="flex-c-m p-lr-10 trans-04" data-bs-toggle="modal" data-bs-target="#modalAyuda">
							Help & FAQs
						</a>
						<?php 
							if(isset($_SESSION['login'])){
