...
-- Tiempo de generación: 21-05-2024 a las 13:43:30
...
--
-- Base de datos: `dbrstudio`
--
CREATE DATABASE IF NOT EXISTS `dbrstudio` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbrstudio`;
...
INSERT INTO `producto` (`idProd`, `nombres`, `precio`, `stock`) VALUES
(1, 'Producto 1', 12.00, 100),
(2, 'Producto 2', 12.00, 100),
(3, 'Producto 3', 15.00, 200),
(4, 'Producto 4', 16.00, 200),
(5, 'Producto 5', 5.00, 300),
(6, 'Producto 6', 20.00, 200),
(7, 'Producto 7', 18.00, 300),
(8, 'Producto 8', 8.00, 200);
--
-- Base de datos: `db_store`
--
CREATE DATABASE IF NOT EXISTS `db_store` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci;
USE `db_store`;
...
(2, '15932020', 'Carlos Enrrique', 'OSH', 78451210, 'carlos@info.com', '008532c27ba741e2017afdc8361de67aeee8070c79b3c45be5e5c72e3ccfda0e', '', '', '', '', 2, '2020-10-03 02:31:07', 1);
...
(1, '4561654687', NULL, NULL, 3, '2021-08-20 03:41:57', '50.00', '450.00', 3, 'Perú,  Perú', 'Completo'),
(2, NULL, '8XD37465755620710', '{\"id\":\"4S6284553D668511R\",\"intent\":\"CAPTURE\",\"status\":\"COMPLETED\",\"purchase_units\":[{\"reference_id\":\"default\",\"amount\":{\"currency_code\":\"USD\",\"value\":\"350.00\"},\"payee\":{\"email_address\":\"sb-6z0da4580133@business.example.com\",\"merchant_id\":\"ULNZF7CTTE748\"},\"description\":\"Compra de artículos en Tienda Virtual por $350 \",\"soft_descriptor\":\"PAYPAL *JOHNDOESTES\",\"shipping\":{\"name\":{\"full_name\":\"John Doe\"},\"address\":{\"address_line_1\":\"Free Trade Zone\",\"admin_area_2\":\"Perú City\",\"admin_area_1\":\"Perú City\",\"postal_code\":\"01001\",\"country_code\":\"GT\"}},\"payments\":{\"captures\":[{\"id\":\"8XD37465755620710\",\"status\":\"COMPLETED\",\"amount\":{\"currency_code\":\"USD\",\"value\":\"350.00\"},\"final_capture\":true,\"seller_protection\":{\"status\":\"ELIGIBLE\",\"dispute_categories\":[\"ITEM_NOT_RECEIVED\",\"UNAUTHORIZED_TRANSACTION\"]},\"create_time\":\"2021-08-20T09:48:38Z\",\"update_time\":\"2021-08-20T09:48:38Z\"}]}}],\"payer\":{\"name\":{\"given_name\":\"John\",\"surname\":\"Doe\"},\"email_address\":\"sb-iimwo4579006@personal.example.com\",\"payer_id\":\"ZTA3QXTY5JS6Q\",\"address\":{\"country_code\":\"GT\"}},\"create_time\":\"2021-08-20T09:46:25Z\",\"update_time\":\"2021-08-20T09:48:38Z\",\"links\":[{\"href\":\"https://api.sandbox.paypal.com/v2/checkout/orders/4S6284553D668511R\",\"rel\":\"self\",\"method\":\"GET\"}]}', 3, '2021-08-20 03:48:39', '50.00', '350.00', 1, 'Perú, Perú', 'Completo');
...
INSERT INTO `persona` (`idpersona`, `identificacion`, `nombres`, `apellidos`, `telefono`, `email_user`, `password`, `nit`, `nombrefiscal`, `direccionfiscal`, `token`, `rolid`, `datecreated`, `status`) VALUES
(1, '24091989', 'Tecomsis', 'TECH', 123456, 'info@tecomsis.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'CF', 'tecomsis TECH', 'Ciudad', NULL, 1, '2021-08-20 01:34:15', 1),
...
(3, '84654864', 'Ricardo', 'Hernández Pérez', 4687987, 'hr@info.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '468798', 'Ricardo HP', 'Ciudad de Perú', NULL, 3, '2021-08-20 03:41:28', 1),
